...
#    And   Notification screen is displayed with message "New Mobile ID Issued" in android device
  ...
  Scenario Outline:ANDR_12_<Reader_Name><Gesture_TC_ID>: Verify Robotic Arm Action and logs when BLE is <BLE_status>, NFC is <NFC_status>, Nearby is <NearByOrLocation_permission>, Location is <location_status>, App State set is <app_state>, device state is <device_state> and display status is <display_status>
    ...
    And   Activity log is displayed in android device and "<date>", "<message>", "<reader_name>", "<action_name>", "<device_state>","<app_state>","<mobile_read>","<display_status>" are verified
...
## NFC
    ...
    Examples:
      | Reader_Name | Gesture_TC_ID | usage_state | BLE_status | NFC_status | NearByOrLocation_permission | location_status | device_state | display_status | app_state  | action_name | date  | message                           | robotic_arm_log | mobile_read    | reader_name |
      | RevE        | _TC-8816343   | Unlocked    | On         | On         | Allow                       | On              | Locked       | On             | Foreground | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293541   | Unlocked    | On         | On         | Allow                       | On              | Unlocked     | On             | Foreground | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293542   | Unlocked    | On         | On         | Allow                       | On              | Unlocked     | On             | Background | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293543   | Unlocked    | On         | On         | Allow                       | On              | Locked       | Off            | Background | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293544   | Unlocked    | On         | On         | Allow                       | On              | Locked       | On             | Background | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293545   | Unlocked    | On         | On         | Allow                       | On              | Unlocked     | On             | Killed     | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293546   | Unlocked    | On         | On         | Allow                       | On              | Locked       | Off            | Killed     | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293547   | Unlocked    | On         | On         | Allow                       | On              | Locked       | On             | Killed     | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |

    @Android12_RevE_Tap_WF_16 @Android12_RevE_NFCTap @Android12_RevE @Android12_RevE_TapRun
    Examples:
      | Reader_Name | Gesture_TC_ID | usage_state | BLE_status | NFC_status | NearByOrLocation_permission | location_status | device_state | display_status | app_state  | action_name | date  | message                           | robotic_arm_log | mobile_read    | reader_name |
      | RevE        | _TC-8816350   | Always      | Off        | On         | Don't allow                 | On              | Locked       | On             | Foreground | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293617   | Always      | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Foreground | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293618   | Always      | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Background | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293619   | Always      | Off        | On         | Don't allow                 | On              | Locked       | Off            | Background | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293620   | Always      | Off        | On         | Don't allow                 | On              | Locked       | On             | Background | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293621   | Always      | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Killed     | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293622   | Always      | Off        | On         | Don't allow                 | On              | Locked       | Off            | Killed     | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293623   | Always      | Off        | On         | Don't allow                 | On              | Locked       | On             | Killed     | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |

    @Android12_RevE_Tap_WF_17 @Android12_RevE_NFCTap @Android12_RevE @Android12_RevE_TapRun
    Examples:
      | Reader_Name | Gesture_TC_ID | usage_state | BLE_status | NFC_status | NearByOrLocation_permission | location_status | device_state | display_status | app_state  | action_name | date  | message                           | robotic_arm_log | mobile_read    | reader_name |
      | RevE        | _TC-8816351   | Foreground  | Off        | On         | Don't allow                 | On              | Locked       | On             | Foreground | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293624   | Foreground  | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Foreground | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293625   | Foreground  | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Background | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293626   | Foreground  | Off        | On         | Don't allow                 | On              | Locked       | Off            | Background | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293627   | Foreground  | Off        | On         | Don't allow                 | On              | Locked       | On             | Background | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293628   | Foreground  | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Killed     | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293629   | Foreground  | Off        | On         | Don't allow                 | On              | Locked       | Off            | Killed     | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293630   | Foreground  | Off        | On         | Don't allow                 | On              | Locked       | On             | Killed     | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |

    @Android12_RevE_Tap_WF_18 @Android12_RevE_NFCTap @Android12_RevE @Android12_RevE_TapRun
    Examples:
      | Reader_Name | Gesture_TC_ID | usage_state | BLE_status | NFC_status | NearByOrLocation_permission | location_status | device_state | display_status | app_state  | action_name | date  | message                           | robotic_arm_log | mobile_read    | reader_name |
      | RevE        | _TC-8816352   | Unlocked    | Off        | On         | Don't allow                 | On              | Locked       | On             | Foreground | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293631   | Unlocked    | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Foreground | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293632   | Unlocked    | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Background | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293633   | Unlocked    | Off        | On         | Don't allow                 | On              | Locked       | Off            | Background | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293634   | Unlocked    | Off        | On         | Don't allow                 | On              | Locked       | On             | Background | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293635   | Unlocked    | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Killed     | TAP         | TODAY | Successful NFC transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
