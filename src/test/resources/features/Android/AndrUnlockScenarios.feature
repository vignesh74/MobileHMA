...
#    And   Notification screen is displayed with message "New Mobile ID Issued" in android device
  ...
  Scenario Outline:ANDR_12_<Reader_Name><Gesture_TC_ID>: Verify Robotic Arm Action and logs when BLE is <BLE_status>, NFC is <NFC_status>, Nearby is <NearByOrLocation_permission>, Location is <location_status>, App State set is <app_state>, device state is <device_state> and display status is <display_status>
    ...
    Examples:
      ...
      | RevE        | _TC-7285089   | Foreground  | On         | Off        | Allow                       | On              | Unlocked     | On             | Killed     | TAP         | TODAY | Successful Bluetooth transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7285090   | Foreground  | On         | Off        | Allow                       | On              | Locked       | Off            | Killed     | TAP         | TODAY | Successful Bluetooth transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7285091   | Foreground  | On         | Off        | Allow                       | On              | Locked       | On             | Killed     | TAP         | TODAY | Successful Bluetooth transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
    ...
    Examples:
      ...
      | RevE        | _TC-7293181q  | Always      | On         | Off        | Don't allow                 | On              | Locked       | On             | Background | TAP         | TODAY | Successful Bluetooth transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
...
## NFC
    ...
    Examples:
      | Reader_Name | Gesture_TC_ID | usage_state | BLE_status | NFC_status | NearByOrLocation_permission | location_status | device_state | display_status | app_state  | action_name | date  | message                     | robotic_arm_log | mobile_read    | reader_name |
      | RevE        | _TC-8816340   | Always      | On         | On         | Allow                       | On              | Locked       | On             | Foreground | TAP         | TODAY | Successful NFC transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
    ...
    Examples:
      | Reader_Name | Gesture_TC_ID | usage_state | BLE_status | NFC_status | NearByOrLocation_permission | location_status | device_state | display_status | app_state  | action_name | date  | message                           | robotic_arm_log | mobile_read    | reader_name |
      | RevE        | _TC-8816350   | Always      | Off        | On         | Don't allow                 | On              | Locked       | On             | Foreground | TAP         | TODAY | Successful Bluetooth transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
    ...
    Examples:
      ...
      | RevE        | _TC-7293624   | Foreground  | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Foreground | TAP         | TODAY | Successful Bluetooth transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      ...
      | RevE        | _TC-7293628   | Foreground  | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Killed     | TAP         | TODAY | Successful Bluetooth transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293629   | Foreground  | Off        | On         | Don't allow                 | On              | Locked       | Off            | Killed     | TAP         | TODAY | Successful Bluetooth transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293630   | Foreground  | Off        | On         | Don't allow                 | On              | Locked       | On             | Killed     | TAP         | TODAY | Successful Bluetooth transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
    ...
    Examples:
      ...
      | RevE        | _TC-7293631   | Unlocked    | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Foreground | TAP         | TODAY | Successful Bluetooth transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293632   | Unlocked    | Off        | On         | Don't allow                 | On              | Unlocked     | On             | Background | TAP         | TODAY | Successful Bluetooth transaction. | TAP:DISABLE     | Mobile ID Read | FavR2       |
      ...
      | RevE        | _TC-7293636   | Unlocked    | Off        | On         | Don't allow                 | On              | Locked       | Off            | Killed     | TAP         | TODAY | Successful Bluetooth transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293637   | Unlocked    | Off        | On         | Don't allow                 | On              | Locked       | On             | Killed     | TAP         | TODAY | Successful Bluetooth transaction. | TAP:ENABLE      | Mobile ID Read | FavR2       |
...
# Twist & Go
    ...
    Examples:
      ...
      | RevE        | _TC-7293251   | Unlocked    | On         | On         | Allow                       | On              | Unlocked     | On             | Background | Twist & Go  | TODAY | Successful Bluetooth transaction. | TWIST_AND_GO=:DISABLE | Mobile ID Read | FavR2       |
      ...
      | RevE        | _TC-7293255   | Unlocked    | On         | On         | Allow                       | On              | Locked       | Off            | Killed     | Twist & Go  | TODAY | Successful Bluetooth transaction. | TWIST_AND_GO:ENABLE   | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293256   | Unlocked    | On         | On         | Allow                       | On              | Locked       | On             | Killed     | Twist & Go  | TODAY | Successful Bluetooth transaction. | TWIST_AND_GO:ENABLE   | Mobile ID Read | FavR2       |
    ...
    Examples:
      ...
      | RevE        | _TC-7293306   | Unlocked    | Off        | On         | Allow                       | On              | Unlocked     | On             | Killed     | Twist & Go  | TODAY | Successful Bluetooth transaction. | TWIST_AND_GO:DISABLE | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293307   | Unlocked    | Off        | On         | Allow                       | On              | Locked       | Off            | Killed     | Twist & Go  | TODAY | Successful Bluetooth transaction. | TWIST_AND_GO:DISABLE | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293308   | Unlocked    | Off        | On         | Allow                       | On              | Locked       | On             | Killed     | Twist & Go  | TODAY | Successful Bluetooth transaction. | TWIST_AND_GO:DISABLE | Mobile ID Read | FavR2       |
    ...
    Examples:
      ...
      | RevE        | _TC-7293313   | Unlocked    | Off        | On         | Allow                       | On              | Unlocked     | On             | Killed     | Twist & Go  | TODAY | Successful Bluetooth transaction. | TWIST_AND_GO:DISABLE | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293314   | Unlocked    | Off        | On         | Allow                       | On              | Locked       | Off            | Killed     | Twist & Go  | TODAY | Successful Bluetooth transaction. | TWIST_AND_GO:DISABLE | Mobile ID Read | FavR2       |
      | RevE        | _TC-7293315   | Unlocked    | Off        | On         | Allow                       | On              | Locked       | On             | Killed     | Twist & Go  | TODAY | Successful Bluetooth transaction. | TWIST_AND_GO:DISABLE | Mobile ID Read | FavR2       |
